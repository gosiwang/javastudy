...
// BombDodgerIDE.java
// (IDE 콘솔 환경에서 실행하기 위해 ANSI 코드를 제거하고 '스크롤 클리어' 방식으로 변경한 버전)

import java.io.*;
import java.util.*;

public class BombDodgerIDE {
    // --- 상수 ---
    ...
    /**
     * IDE 콘솔 호환용 화면 그리기 메서드
     */
    private void drawScreen() {
        // 1. 화면을 밀어내기 위해 새 줄을 잔뜩 출력합니다. (IDE 호환)
        clearScreen();
        ...
        // System.out.flush(); // System.out.print는 자동 flush되는 경향이 있으므로 생략 가능
    }

    /**
     * IDE 콘솔에서 화면을 "지우는" 유일한 방법은
     * 새 줄을 많이 출력해서 이전 내용을 위로 밀어내는 것입니다.
     */
    private void clearScreen() {
        for (int i = 0; i < 40; i++) { // 40줄 정도를 밀어냅니다.
            System.out.println();
        }
    }
